...
public class Main {
        ...
        public static void main(String[] args) {
                ...
                if (!fDatabase.exists()) {
                        conn = initDatabase(filePath);
                } else {
                        conn = UtilsSQLite.connect(filePath);
                }

                Menu m = new Menu();
                m.mostrarmenuprincipal(conn);

        }

        static Connection initDatabase(String filePath) {
                ...
                UtilsSQLite.queryUpdate(conn,
                                "INSERT INTO Personatge (nom, atac, defensa, idFaccio) VALUES ('Guardián', 5, 10, 1);");
                UtilsSQLite.queryUpdate(conn,
                                "INSERT INTO Personatge (nom, atac, defensa, idFaccio) VALUES ('Gladiador', 7, 8, 1);");
                UtilsSQLite.queryUpdate(conn,
                                "INSERT INTO Personatge (nom, atac, defensa, idFaccio) VALUES ('Shinobi', 10, 6, 2);");
                UtilsSQLite.queryUpdate(conn,
                                "INSERT INTO Personatge (nom, atac, defensa, idFaccio) VALUES ('Shugoki', 8, 10, 2);");
                UtilsSQLite.queryUpdate(conn,
                                "INSERT INTO Personatge (nom, atac, defensa, idFaccio) VALUES ('Invasor', 9, 7, 3);");
                UtilsSQLite.queryUpdate(conn,
                                "INSERT INTO Personatge (nom, atac, defensa, idFaccio) VALUES ('Valquiria', 8, 10, 3);");
